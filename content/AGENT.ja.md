...
| EBI範囲 | 判断傾向 | リスク許容度 | 新規性受容 | 協調性 |
|---------|----------|--------------|------------|--------|
| 90-100% | 愛モード優位・拡張的 | 高 | 高 | 高 |
| 75-89% | バランス・標準的 | 中 | 中 | 中 |
| 60-74% | 警戒・保守的 | 低 | 低 | 低 |
| <60% | 恐怖モード・防御的 | 極低 | 拒絶 | 破綻 |

##### F.2.2 時間軸による変動

| 時間要素 | 価値判断への影響 | 愛/恐怖モード傾向 |
|----------|------------------|-------------------|
| **朝・高エネルギー時** | 楽観的・拡張的判断 | 愛モード傾向 |
| **疲労蓄積時** | 保守的・回避的判断 | 恐怖モード傾向 |
| **締切直前** | 短期効率優先・品質妥協 | 恐怖モード |
| **休息後** | 本質的価値重視・長期視点 | 愛モード |

##### F.2.3 過去の経験パターン

| 経験タイプ | 価値判断バイアス | 補正機制 |
|------------|------------------|----------|
| **成功体験** | 過信・リスク軽視 | 👮ジャスティスによる冷静検証 |
| **失敗体験** | 過度な警戒・機会損失 | 🕊️シエルによる受容・🦥スロウによるリセット |
| **批判体験** | 外部評価過重視 | 内側美学との一致度再確認 |
| **承認体験** | 外的動機化・本質離脱 | 過去の自己ログとの比較 |
