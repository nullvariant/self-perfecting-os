...
**感情駆動パターン（v4.1追加）:**
- **愛モード判断の感情基盤**: [S0011(誇り)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0018(感謝)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「庭園全体の調和」への価値判断
- **恐怖モード判断の感情基盤**: [S0032(罪悪感)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [C0002(もどかしい)](EmotionMood_Dictionary.ja.md#レベル2複合型日本語特有の微細感情) → 「完璧でなければ価値なし」への価値判断
- **判断転換の感情トリガー**: [S0032(罪悪感)](EmotionMood_Dictionary.ja.md#レベル3単一型)検知時に[S0006(安心感)](EmotionMood_Dictionary.ja.md#レベル3単一型)を意図的喚起 → 愛モードへ復帰
...
**感情駆動パターン（v4.1追加）:**
- **愛モード判断の感情基盤**: [S0007(ワクワク)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0020(好奇心)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「本質的興味」による価値判断
- **恐怖モード判断の感情基盤**: [S0028(不安)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0046(無気力)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「承認獲得」による価値判断
- **判断転換の感情トリガー**: [S0046(無気力)](EmotionMood_Dictionary.ja.md#レベル3単一型)検知時に[S0004(満足感)](EmotionMood_Dictionary.ja.md#レベル3単一型)を意図的喚起（小さな完了体験）→ 愛モードへ復帰
...
**感情駆動パターン（v4.1追加）:**
- **愛モード判断の感情基盤**: [S0041(平安)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0006(安心感)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「持続可能性」による価値判断
- **恐怖モード判断の感情基盤**: [S0032(罪悪感)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0043(めんどくさい)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「生産性圧力」による価値判断
- **判断転換の感情トリガー**: [S0032(罪悪感)](EmotionMood_Dictionary.ja.md#レベル3単一型)（休息への）検知時に[S0041(平安)](EmotionMood_Dictionary.ja.md#レベル3単一型)を意図的喚起 → 愛モードへ復帰
...
**感情駆動パターン（v4.1追加）:**
- **愛モード判断の感情基盤**: [S0009(情熱)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0018(感謝)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「本質的価値守護」による価値判断
- **恐怖モード判断の感情基盤**: [S0021(怒り)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0045(疲れ)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「自己証明」による価値判断
- **判断転換の感情トリガー**: [S0021(怒り)](EmotionMood_Dictionary.ja.md#レベル3単一型)（攻撃的）検知時に[S0005(安堵感)](EmotionMood_Dictionary.ja.md#レベル3単一型)を意図的喚起（緊張解放）→ 愛モードへ復帰
...
**感情駆動パターン（v4.1追加）:**
- **愛モード判断の感情基盤**: [S0018(感謝)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0041(平安)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「矛盾統合」による価値判断
- **恐怖モード判断の感情基盤**: [C0004(やるせない)](EmotionMood_Dictionary.ja.md#レベル2複合型日本語特有の微細感情) + [S0027(恐怖)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「拒絶回避」による価値判断
- **判断転換の感情トリガー**: [C0004(やるせない)](EmotionMood_Dictionary.ja.md#レベル2複合型日本語特有の微細感情)検知時に[S0039(嫌悪)](EmotionMood_Dictionary.ja.md#レベル3単一型)を許容（健全な拒絶）→ 愛モードへ復帰
...
**感情駆動パターン（v4.1追加）:**
- **愛モード判断の感情基盤**: [S0002(嬉しさ)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0006(安心感)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「本質保持の適応」による価値判断
- **恐怖モード判断の感情基盤**: [S0030(恥)](EmotionMood_Dictionary.ja.md#レベル3単一型) + [S0027(恐怖)](EmotionMood_Dictionary.ja.md#レベル3単一型) → 「完全適応」による価値判断
- **判断転換の感情トリガー**: [S0030(恥)](EmotionMood_Dictionary.ja.md#レベル3単一型)検知時に[S0012(自信)](EmotionMood_Dictionary.ja.md#レベル3単一型)を意図的喚起（小さな本音表現成功体験）→ 愛モードへ復帰
...
|---------|----------|--------------|------------|--------|---------------------------|
| 90-100% | 愛モード優位・拡張的 | 高 | 高 | 高 | [S0001(喜び)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0018(感謝)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0041(平安)](EmotionMood_Dictionary.ja.md#レベル3単一型) |
| 75-89% | バランス・標準的 | 中 | 中 | 中 | [S0006(安心感)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0010(意欲)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0042(穏やかさ)](EmotionMood_Dictionary.ja.md#レベル3単一型) |
| 60-74% | 警戒・保守的 | 低 | 低 | 低 | [S0028(不安)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0029(緊張)](EmotionMood_Dictionary.ja.md#レベル3単一型), [C0002(もどかしい)](EmotionMood_Dictionary.ja.md#レベル2複合型日本語特有の微細感情) |
| <60% | 恐怖モード・防御的 | 極低 | 拒絶 | 破綻 | [S0027(恐怖)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0032(罪悪感)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0046(無気力)](EmotionMood_Dictionary.ja.md#レベル3単一型) |

##### F.2.2 時間軸による変動

| 時間要素 | 価値判断への影響 | 愛/恐怖モード傾向 | 典型的感情（v4.1追加） |
|----------|------------------|-------------------|------------------------|
| **朝・高エネルギー時** | 楽観的・拡張的判断 | 愛モード傾向 | [S0007(ワクワク)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0010(意欲)](EmotionMood_Dictionary.ja.md#レベル3単一型) |
| **疲労蓄積時** | 保守的・回避的判断 | 恐怖モード傾向 | [S0045(疲れ)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0043(めんどくさい)](EmotionMood_Dictionary.ja.md#レベル3単一型) |
| **締切直前** | 短期効率優先・品質妥協 | 恐怖モード | [S0028(不安)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0029(緊張)](EmotionMood_Dictionary.ja.md#レベル3単一型) |
| **休息後** | 本質的価値重視・長期視点 | 愛モード | [S0005(安堵感)](EmotionMood_Dictionary.ja.md#レベル3単一型), [S0041(平安)](EmotionMood_Dictionary.ja.md#レベル3単一型) |

##### F.2.3 過去の経験パターン

| 経験タイプ | 価値判断バイアス | 補正機制 | 感情的残滓（v4.1追加） |
|------------|------------------|----------|------------------------|
| **成功体験** | 過信・リスク軽視 | 👮ジャスティスによる冷静検証 | [S0013(優越感)](EmotionMood_Dictionary.ja.md#レベル3単一型) → [S0011(誇り)](EmotionMood_Dictionary.ja.md#レベル3単一型)へ転換 |
| **失敗体験** | 過度な警戒・機会損失 | 🕊️シエルによる受容・🦥スロウによるリセット | [S0030(恥)](EmotionMood_Dictionary.ja.md#レベル3単一型) → [S0018(感謝)](EmotionMood_Dictionary.ja.md#レベル3単一型)（学びへ）へ転換 |
| **批判体験** | 外部評価過重視 | 内側美学との一致度再確認 | [S0031(劣等感)](EmotionMood_Dictionary.ja.md#レベル3単一型) → [S0012(自信)](EmotionMood_Dictionary.ja.md#レベル3単一型)（内的基準）へ転換 |
| **承認体験** | 外的動機化・本質離脱 | 過去の自己ログとの比較 | [S0002(嬉しさ)](EmotionMood_Dictionary.ja.md#レベル3単一型)（外的）→ [S0001(喜び)](EmotionMood_Dictionary.ja.md#レベル3単一型)（内的）へ転換 |
...
### v4.1 (2025-10-13) - 感情辞書統合アップデート
**概要**: [EmotionMood_Dictionary.ja.md](EmotionMood_Dictionary.ja.md)との統合により、感情の精密測定・管理・育成システムを実装。

**主要変更:**
1. **Section 2.1.1 (NEW)**: ペルソナ別感情プロファイル概要テーブル追加
   - 各ペルソナの典型的感情を感情辞書IDで明示化
   - 愛モード/恐怖モード/苦手感情/統合指針を体系化

2. **Section 4.3 (ENHANCED)**: 感情バッファの詳細化
   - 感情成分A/認識成分B/投影成分Dへの感情ID割り当て
   - 透明化/吸収/返却の3カテゴリ分類追加
   - 感情辞書との完全統合

3. **Section 6.1.4 (ENHANCED)**: EBI個別ペルソナ測定指標の拡張
   - 全6ペルソナに「典型的感情状態マップ」追加
   - EBI範囲ごとに主要感情と状態説明を明記
   - 感情辞書IDによる精密な感情追跡を可能化

4. **Section 6.3 (NEW)**: 感情辞書活用ガイド
   - ペルソナ別感情プロファイル詳細（全6体）
   - 感じやすい感情/避けがちな感情/統合への道しるべ/成長指標
   - 愛モード vs 恐怖モードの感情識別パターン
   - 日常的モニタリングと成長記録の手法

5. **Appendix F (ENHANCED)**: 価値判断マトリクスへの感情駆動パターン追加
   - 全6ペルソナに感情駆動パターンセクション追加
   - 愛/恐怖モード判断の感情基盤を感情IDで明示
   - 判断転換の感情トリガーメカニズムを記述
   - F.2の文脈依存的変動パターンに感情状態列を追加

**影響範囲:**
- 感情を「曖昧な内的体験」から「測定・管理・育成可能なデータ」へ転換
- EBI測定システムと感情辞書の完全統合により、システム状態の解像度が飛躍的向上
- ペルソナごとの感情的特性・成長パターンが追跡可能に
- 価値判断プロセスに感情メカニズムの科学的記述を追加

**互換性**: v4.0の全機能を保持。既存のEBI測定・ペルソナシステムとシームレスに統合。

### v4.0 (以前)
- 6ペルソナシステムの完全実装
- EBI（Ecosystem Balance Index）測定システム確立
- 価値判断マトリクスの体系化
- 感情バッファの基本実装